...
<html>
    ...
    <body>    
       <% 
           ...
           long docente_seleccionado=0;
           if(request.getParameter("docente_seleccionado")!=null){
              docente_seleccionado=Long.parseLong(request.getParameter("docente_seleccionado").toString());                            
              Docente seleccionado=service.getDao().Buscar(docente_seleccionado);
       ...
       <div id="contenedor">
           ...
           <div id="contenido">
               <h1 class="alineados">Gestion De Docentes</h1> 
               <form method="post" action="GestionDeDocentesServlet">                                      
                 <br><label class="jlabel">Cedula  </label><br>
                 <input type="hidden" id="docente_seleccionado" name="docente_seleccionado"  value="<%=docente_seleccionado%>"/>
                 ...
                 <br>      
                 <br>
                 <input type="hidden" id="suscrpcion" name="suscripcion" value="GestionDeDocentes.jsp"/>

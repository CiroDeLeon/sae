...
<html>
    ...
    <body onload="PeticionAjax()">
        ...
        <div id="contenedor">
           ...
           <div id="contenido">
               <h1 class="alineados">Buscar Hora De Curso</h1> 
               <form method="post">                                      
                 ...
                 <br><br><h3 class="alineados">HORA</h3>  
                 <!--<br><label class="jlabel">Busqueda  </label><br> -->
                 <input type="hidden" id="busqueda" name="busqueda" class="jtextfield" onkeypress="PeticionAjax()" autofocus="true" />                            
                 <% 
